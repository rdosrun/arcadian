...
function Query_Customers(offset=0){
    var postData = JSON.stringify({
...
function Sales_Orders(offset = 0){
    var postData = JSON.stringify({
...
function sales_order_lines(SALESORDER_INTERNAL_ID=0){
    var postData = JSON.stringify({
